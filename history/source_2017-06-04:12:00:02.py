...
def main():
        ...
        ddir = './data/raw/'
        theta1, theta2, J, a1, a2, a3, output_label, result, score, X, y, output = costLowerer(ddir, nneurons = 25, lam=1, alpha = 1e-5, num_iters=1000, reg=True, run_test=False, rdm_init=True)
